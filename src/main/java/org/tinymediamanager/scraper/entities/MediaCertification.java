...
public enum MediaCertification {
  ...
  CA_14A(CountryCode.CA, "14A", new String[] { "14+", "14A" }),
  CA_16(CountryCode.CA, "16", new String[] { "16", "16+" }),
  CA_18A(CountryCode.CA, "18A", new String[] { "18", "18+", "18A" }),
  ...
  FR_10(CountryCode.FR, "10", new String[] { "10", "–10" }),
  FR_12(CountryCode.FR, "12", new String[] { "12", "–12" }),
  FR_14(CountryCode.FR, "14+", new String[] { "14+" }),
  FR_16(CountryCode.FR, "16", new String[] { "16", "–16" }),
  FR_18(CountryCode.FR, "18", new String[] { "18", "–18" }),
  ...
  GB_12(CountryCode.GB, "12", new String[] { "12", "12+", "12A" }),
  ...
  KR_(CountryCode.KR, "청불", new String[] { "청불" }),
  ...
  NG_12(CountryCode.NG, "12", new String[] { "12", "12A" }),
  ...
  RO_IC14(CountryCode.RO, "I.C.-14", new String[] { "I.C.-14" }),
  ...
  SK_7(CountryCode.SK, "7", new String[] { "7", "-7", "7+" }),
  ...
  TH_PG13(CountryCode.TH, "PG 13", new String[] { "PG 13" }),
  ...
  TR_10(CountryCode.TR, "10+", new String[] { "10+", "10A" }),
  TR_13(CountryCode.TR, "13+", new String[] { "13+", "13A", "u 13+" }),
  TR_16(CountryCode.TR, "16+", new String[] { "16+" }),
  TR_18(CountryCode.TR, "18+", new String[] { "18+", "u 18+" }),
  TR_6(CountryCode.TR, "6+", new String[] { "6+", "6A" }),
