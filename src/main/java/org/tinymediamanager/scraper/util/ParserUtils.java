...
public class ParserUtils {
  ...
  protected static final String[] HARD_STOPWORDS  = { "1080", "1080i", "1080p", "2160p", "2160i", "3d", "480i", "480p", "576i", "576p", "360p",
      ...
      "dvd8", "dvd9", "dvdivx", "dvdrip", "dvdscr", "dvdscreener", "emule", "etm", "fs", "fps", "german", "h264", "hd", "hddvd", "hdrip", "hdtv",
      "hdtvrip", "hevc", "hrhd", "hrhdtv", "ind", "ld", "md", "microhd", "multisubs", "mp3", "nfo", "nfofix", "ntg", "ntsc", "ogg", "ogm", "pal",
      "pdtv", "pso", "r3", "r5", "repack", "rerip", "remux", "roor", "rs", "rsvcd", "screener", "sd", "subbed", "subs", "svcd", "swedish", "tc",
      "telecine", "telesync", "ts", "truehd", "uhd", "uncut", "unrated", "vcf", "vhs", "vhsrip", "webdl", "webrip", "workprint", "ws", "x264", "xf",
      "xvid", "xvidvd", "8bit", "10bit", "12bit" };
