...
/**
 * The class {@link TvShowEpisodeOtherIdsConverter} is used to display the other ids in a string format
 *
 * @author Manuel Laggner
 */
public class TvShowEpisodeOtherIdsConverter extends Converter<Map<String, Object>, String> {
