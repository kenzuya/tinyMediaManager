  ...
  private void initComponents() {
    setLayout(new MigLayout("", "[600lp,grow]", "[]"));
    {
      ...
      add(collapsiblePanel, "cell 0 0,growx, wmin 0");
      {
        ...
        panelFileNaming.add(chckbxFanart2, "cell 2 4");
        ...
        panelFileNaming.add(chckbxSeasonThumb3, "cell 2 18");
